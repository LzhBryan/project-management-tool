...
const SIDEBAR_WIDTH = "clamp(16rem, 6.8571rem + 19.0476vw, 24rem)"
const SIDEBAR_WIDTH_MOBILE = "clamp(16rem, 11.7143rem + 21.4286vw, 22rem)"
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  if (collapsible === "none") {
    return (
      <div
        className={cn("flex h-full w-[--sidebar-width] bg-sidebar text-sidebar-foreground", className)}
        ref={ref}
        {...props}
      >
        {children}
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className="w-[--sidebar-width] border-r-0 bg-sidebar p-6 text-sidebar-foreground [&>button]:hidden"
          style={
            {
